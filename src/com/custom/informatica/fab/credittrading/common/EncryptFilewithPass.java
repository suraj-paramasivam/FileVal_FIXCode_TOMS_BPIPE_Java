...
import com.custom.informatica.fab.credittrading.toms.TomsAll;
...
public class EncryptFilewithPass {
    public static final Logger logger = Logger.getLogger(EncryptFilewithPass.class);
    ...
    private static Cipher makeCipher(String pass, Boolean decryptMode) throws GeneralSecurityException{
        ...
        EncryptFilewithPass.keyToFile(key);
    ...
    public static void encryptFile(String fileName, String pass)
        ...
        Cipher cipher = EncryptFilewithPass.makeCipher(pass, true);
    ...
    public static void decryptFile(String fileName, String pass)
        ...
        //Generate the cipher using pass:
        Cipher cipher = EncryptFilewithPass.makeCipher(pass, false);
    ...
    public static void main(String[] args){
        PropertyConfigurator.configure("res/encrypt_file_toms_logging.properties");
